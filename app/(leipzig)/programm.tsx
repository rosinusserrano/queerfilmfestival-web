...
export const programmFreitag: ProgrammEntry[] = [
	{
		title: "Jugendspielfilm: So damm easy going",
		location: locations.luru,
		time: "14:00 - 15:45",
		description: (
			<>
				...
				<h3>
					SO DAMN EASY GOING (2022) / 91min /Christoffer Sandler mit Nikki H.,
					Melina P., Shanti R. Und Emil A. / language: swedish with german
					subtitels
				</h3>
				<p>
					CN: Flashlight, Ableism, Depression, Classism, Death of parent,
					Neglect of care work, Sexism, Drugs (marijuana), Social anxiety, Low
					self-esteem
				</p>
				<h4>Synopsis</h4>
				<p>
					A rollercoaster is spinning wildly in Joanna's head, everything is
					constantly in motion. Medically speaking, she has ADHD. In the short
					term, non-committal sex with her classmate Matheus, swimming in the
					pool and, above all, her medication help. But when they run out and
					her unemployed father can't help either, Joanna has to get creative to
					find money herself. In the midst of the chaos, a new classmate
					suddenly appears before her, the cool and self-confident Audrey. And
					Joanna no longer just has flashing thoughts, but also a wildly beating
					heart.
				</p>
				<h4>Background</h4>
				<p>
					JENNY JÄGERFELD (author of the original novel) is an author and
					psychologist. Her experiences from her work as a psychologist were
					heavily incorporated into the book, e.g. the fears and worries of
					young adults and what it means for children to grow up with depressed
					parents and in poverty. In an interview, the three screenwriters
					describe the lengthy research required to portray the topics covered
					in a sensitive and authentic way. In the online ADHD forum
					(Oase-ADHS.de), the film and the book have been positively received.
					Above all, the portrayal of ADHD in FLINTA* people is still
					underrepresented today and all the more important.
				</p>

				<p>deutsch:</p>

				<h3>
					SO DAMN EASY GOING (2022) | 91min |Christoffer Sandler mit | Sprache:
					Schwedisch mit deutschem Untertitel
				</h3>

				<p>
					CN: Blitzlicht, Ableismus, Depression, Klassismus, Tod von Elternteil,
					Vernachlässigung der Sorgearbeit, Sexismus, Drogen (Marihuana),
					Soziale Ängste, geringes Selbstwertgefühl
				</p>
				<h4>Inhalt</h4>
				<p>
					In Joannas Kopf dreht eine Achterbahn wilde Loopings, alles ist
					ständig in Bewegung. Medizinisch gesagt: Sie hat ADHS. Kurzfristig
					helfen unverbindlicher Sex mit ihrem Mitschüler Matheus, Schwimmen im
					Pool und vor allem ihre Medikamente. Doch als die ausgehen und ihr
					arbeitsloser Vater auch nicht helfen kann, muss Joanna kreativ werden,
					um selbst an Geld zu kommen. Mitten im Chaos steht plötzlich eine neue
					Klassenkameradin vor ihr, die coole und selbstbewusste Audrey. Und
					Joanna hat nicht mehr nur blitzende Gedanken, sondern auch ein wild
					pochendes Herz.
				</p>
				<h4>Kontext</h4>
				<p>
					JENNY JÄGERFELD (Autorin der Romanvorlage) ist Autorin und
					Psychologin. Ihre Erfahrungen aus ihrer psychologischen Tätigkeit
					flossen stark in das Buch mit ein, z.B. die Ängste und Sorgen junger
					Erwachsener und was es für Kinder bedeutet, mit depressiven Eltern und
					in Armut aufzuwachsen. Die drei Drehbuchautor*innen beschreiben in
					einem Interview eine lange Recherchezeit um die behandelten Themen
					sensibel und authentisch darstellen zu können. Im online ADHS-Forum
					(Oase-ADHS.de) wird der Film und das Buch positiv aufgenommen. Vor
					allem die Darstellung von ADHS bei FLINTA* Personen ist heute immer
					noch unterrepresentiert und umso wichtiger.
				</p>
			</>
		),
	},
...
export const programmSonntag: ProgrammEntry[] = [
	...
	},
	{
		title: (
			<s>
				Workshop 06: Subtle Seductions: Queer Performance & Dance Workshop with
				Emil
			</s>
		),
		location: locations.fuge,
		...
		description: (
			<>
				<p>
					<b>WEGEN KRANKHEIT VERSCHOBEN AUF MITTE DEZEMBER</b>
				</p>
				<p>
					Adresse:
					<br />
